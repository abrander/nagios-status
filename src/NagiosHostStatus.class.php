...
class HostStatus extends StatusBase {
	var $fields = [
		...
		'last_hard_state' => self::NAGIOS_INTEGER, // FIXME!
		...
		'performance_data' => self::NAGIOS_STRING,
		'last_check' => self::NAGIOS_TIMESTAMP,
		'next_check' => self::NAGIOS_TIMESTAMP,
		'check_options' => self::NAGIOS_INTEGER,
		...
		'last_time_up' => self::NAGIOS_TIMESTAMP,
		'last_time_down' => self::NAGIOS_TIMESTAMP,
		'last_time_unreachable' => self::NAGIOS_TIMESTAMP,
		'last_notification' => self::NAGIOS_TIMESTAMP,
		'next_notification' => self::NAGIOS_TIMESTAMP,
		'no_more_notifications' => self::NAGIOS_UNKNOWN,
		...
		'obsess_over_host' => self::NAGIOS_BOOLEAN,
